...
); //Me gusta esto ;), re resumido y simple
...
let consulta = prompt("Desea realizar otra consulta?").toUpperCase(); //a mayus

while (consulta === "SI") {
  //Mejor asi!
  consultas();
  consulta = prompt("Desea realizar otra consulta?").toUpperCase();
}
